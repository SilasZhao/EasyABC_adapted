...
def main():
    ...
    output_filename = '/Users/zhaosongyan/Desktop/Symbtr_ABC/'
    key = None
...
# create the csv writer
    folder = '/Users/zhaosongyan/Downloads/SymbTr-2.0.0/midi/'
    valid_num = 0
    ...
    for file_name in os.listdir(folder):
        ...
        try:
            ...
            result = midi_to_abc(folder+file_name, None, key, metre, default_len, bars_per_line, title, source,
                                no_triplets, no_broken_rythms, slur_8th_pairs, slur_16th_pairs, no_beam_breaks=no_beam_breaks)
            valid_num += 1 
            # output to stdout or file
            if output_filename:
                l = len(file_name)
                open(output_filename+file_name[:l - 4]+".abc", 'w').write(result)
            else:
                print(result)
        except:
            print("Error when parsing: "+file_name)
    print("done,successfully parsed %s files")
# def main(argv):
#     # setup default values
#     filename = ''
#     output_filename = ''
